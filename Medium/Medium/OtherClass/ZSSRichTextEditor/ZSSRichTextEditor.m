...
- (void)viewDidLoad {
    ...
    UIView *view_navigation = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 60)];
    view_navigation.backgroundColor = [UIColor whiteColor];
    
    UIButton *btn =  [UIButton buttonWithType:UIButtonTypeSystem];
    [btn setFrame:CGRectMake(0, 20, 60, 40)];
    ...
    [view_navigation addSubview:btn];
    
    UIButton *btnNext =  [UIButton buttonWithType:UIButtonTypeSystem];
    [btnNext setFrame:CGRectMake(self.view.frame.size.width-60, 20, 60, 40)];
    ...
    UIButton *btnDrafts =  [UIButton buttonWithType:UIButtonTypeSystem];
    [btnDrafts setFrame:CGRectMake(self.view.frame.size.width-120, 20, 60, 40)];
    ...
    UILabel *lblline = [[UILabel alloc] initWithFrame:CGRectMake(0, view_navigation.frame.size.height-1, self.view.frame.size.width, 1)];
    lblline.backgroundColor = [UIColor lightGrayColor];
    [view_navigation addSubview:lblline];
    
    [self.view addSubview:view_navigation];
...
- (void)createToolBarScroll {
    ...
    self.toolBarScroll = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0,self.view.frame.size.width, 44)];
...
- (void)createParentHoldingView {
    ...
    int devided = self.view.frame.size.width / 6;
    
    btnText =  [UIButton buttonWithType:UIButtonTypeCustom];
    [btnText setFrame:CGRectMake(0, 0, devided, 44)];
    [btnText setImage:[UIImage imageNamed:@"ic_editor_title_0_24dp.png"] forState:UIControlStateNormal];
    //[btnText setImage:[UIImage imageNamed:@"ic_editor_title_1_24dp.png"] forState:UIControlStateSelected];
    //[btnText setImage:[UIImage imageNamed:@"ic_editor_title_2_24dp.png"] forState:UIControlStateFocused];
    [btnText addTarget:self action:@selector(ChangeText:) forControlEvents:UIControlEventTouchUpInside];
    [self.toolbarHolder addSubview:btnText];

    
    btnQuote =  [UIButton buttonWithType:UIButtonTypeCustom];
    [btnQuote setFrame:CGRectMake(devided*1, 0, devided, 44)];
    [btnQuote setImage:[UIImage imageNamed:@"ic_editor_quote_0_24dp.png"] forState:UIControlStateNormal];
    //[btnQuote setImage:[UIImage imageNamed:@"ic_editor_quote_1_24dp.png"] forState:UIControlStateSelected];
    //[btnQuote setImage:[UIImage imageNamed:@"ic_editor_quote_2_24dp.png"] forState:UIControlStateFocused];
    [btnQuote addTarget:self action:@selector(ChangeQuote:) forControlEvents:UIControlEventTouchUpInside];
    [self.toolbarHolder addSubview:btnQuote];

    
    btnList =  [UIButton buttonWithType:UIButtonTypeCustom];
    [btnList setFrame:CGRectMake(devided*2, 0, devided, 44)];
    [btnList setImage:[UIImage imageNamed:@"ic_editor_list_0_24dp.png"] forState:UIControlStateNormal];
    //[btnList setImage:[UIImage imageNamed:@"ic_editor_list_0_24dp.png"] forState:UIControlStateSelected];
    //[btnList setImage:[UIImage imageNamed:@"ic_editor_list_0_24dp.png"] forState:UIControlStateFocused];
    [btnList addTarget:self action:@selector(ChangeListType:) forControlEvents:UIControlEventTouchUpInside];
    [self.toolbarHolder addSubview:btnList];

    
    UIButton *btnSection =  [UIButton buttonWithType:UIButtonTypeCustom];
    [btnSection setFrame:CGRectMake(devided*3, 0, devided, 44)];
    [btnSection setImage:[UIImage imageNamed:@"ic_editor_section_24dp.png"] forState:UIControlStateNormal];
    [btnSection addTarget:self action:@selector(AddSectionView:) forControlEvents:UIControlEventTouchUpInside];
    [self.toolbarHolder addSubview:btnSection];

    
    UIButton *btnLink =  [UIButton buttonWithType:UIButtonTypeCustom];
    [btnLink setFrame:CGRectMake(devided*4, 0, devided, 44)];
    ...
    [btnimage setImage:[UIImage imageNamed:@"ic_editor_photo_24dp.png"] forState:UIControlStateNormal];
    [btnimage addTarget:self action:@selector(AddImageView:) forControlEvents:UIControlEventTouchUpInside];
...
-(IBAction)ChangeQuote:(id)sender
{
    ...
    [btn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"ic_editor_quote_%d_24dp.png",setQuoteImage]] forState:UIControlStateNormal];
...
-(void)setDefaultButton
{
    ...
    [btnText setImage:[UIImage imageNamed:[NSString stringWithFormat:@"ic_editor_title_%d_24dp.png",setTitleImage]] forState:UIControlStateNormal];
    [btnQuote setImage:[UIImage imageNamed:[NSString stringWithFormat:@"ic_editor_quote_%d_24dp.png",setQuoteImage]] forState:UIControlStateNormal];
    [btnList setImage:[UIImage imageNamed:[NSString stringWithFormat:@"ic_editor_list_%d_24dp.png",setListImage]] forState:UIControlStateNormal];
}

-(IBAction)AddSectionView:(id)sender
{
